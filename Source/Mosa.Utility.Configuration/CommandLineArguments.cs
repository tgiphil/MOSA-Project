...
public static class CommandLineArguments
{
	...
	private static List<Argument> GetMap()
	{
		var map = new List<Argument>
		{
			...
			new Argument { Name = "-bisect-persist-state", Setting = Name.UnitTest_Bisector_StateFile},
			...
			new Argument { Name = "-bisect-reset-state", Setting = Name.UnitTest_Bisector_ResetState, Value = "true"},
