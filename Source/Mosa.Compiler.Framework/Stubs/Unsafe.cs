...
internal static partial class StubMethods
{
	...
	public static void Unsafe_SizeOf(Context context, TransformContext transform)
	{
	...
	public static void Unsafe_As(Context context, TransformContext transform)
	{
	...
	public static void Unsafe_AreSame(Context context, TransformContext transform)
	{
		CILDecoderStage.CreateParameters(transform.MethodCompiler);
	...
	public static void Unsafe_AddByteOffset(Context context, TransformContext transform)
	{
		CILDecoderStage.CreateParameters(transform.MethodCompiler);
