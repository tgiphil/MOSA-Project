...
internal static partial class StubMethods
{
	...
	public static void ByReference__ctor(Context context, TransformContext transform)
	{
	...
	public static void ByReference_get_Value(Context context, TransformContext transform)
	{
		CILDecoderStage.CreateParameters(transform.MethodCompiler);
