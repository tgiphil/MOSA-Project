...
public sealed class AddressOf : BaseIRTransform
{
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		{
			context.SetInstruction(X86.Lea32Ext, context.Result, transform.StackFrame, Operand.Constant32_0, Operand.Constant32_1, context.Operand1);
		}
		else
		{
			var offset = Operand.CreateConstant32(context.Operand1.Offset);

			context.SetInstruction(X86.Lea32Ext, context.Result, transform.StackFrame, Operand.Constant32_0, Operand.Constant32_1, offset);
		}
	}
}
